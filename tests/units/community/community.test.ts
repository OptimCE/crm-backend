...
import { expectWithLog, mockCommunityRepositoryModule, mockIAMServiceModule, mockAuthContextRepositoryModule } from "../../utils/helper.js";
import {
...
describe("(Unit) Community Module", () => {
  ...
  describe("(Unit) Get My Communities", () => {
    ...
    it.each(testCasesGetMyCommunities)(
      ...
      async ({ id_user, query, status_code, expected_error_code, expected_data, expected_pagination, mocks }) => {
        ...
        const response = await request(app).get("/communities/my-communities").query(query).set("x-user-id", id_user.toString());
  ...
  describe("(Unit) Get Users", () => {
    ...
    it.each(testCasesGetUsers)(
      ...
      async ({ id_user, id_community, orgs, query, status_code, expected_error_code, expected_data, mocks }) => {
        if (mocks?.communityRepo) await mockCommunityRepositoryModule(mocks.communityRepo);
  ...
  describe("(Unit) Create Community", () => {
    ...
    it.each(testCasesCreateCommunity)(
      ...
      async ({ id_user, query, status_code, expected_error_code, expected_data, mocks, translation_field }) => {
        if (mocks?.communityRepo) await mockCommunityRepositoryModule(mocks.communityRepo);
        ...
        const response = await request(app).post("/communities").send(query).set("x-user-id", id_user.toString());
  ...
  describe("(Unit) Update Community", () => {
    ...
    it.each(testCasesUpdateCommunity)(
      ...
      async ({ id_user, id_community, orgs, query, status_code, expected_error_code, expected_data, mocks, translation_field }) => {
        if (mocks?.communityRepo) await mockCommunityRepositoryModule(mocks.communityRepo);
        if (mocks?.iamService) await mockIAMServiceModule(mocks.iamService);
        if (mocks?.authContext) await mockAuthContextRepositoryModule(mocks.authContext);
  ...
  describe("(Unit) Leave Community", () => {
    ...
    it.each(testCasesLeave)(
      ...
      async ({ id_user, id_community, orgs, status_code, expected_error_code, expected_data, mocks }) => {
        if (mocks?.communityRepo) await mockCommunityRepositoryModule(mocks.communityRepo);
        if (mocks?.iamService) await mockIAMServiceModule(mocks.iamService);
        if (mocks?.authContext) await mockAuthContextRepositoryModule(mocks.authContext);
  ...
  describe("(Unit) Kick User", () => {
    ...
    it.each(testCasesKick)(
      ...
      async ({ id_user, id_community, orgs, target_user_id, status_code, expected_error_code, expected_data, mocks }) => {
        if (mocks?.communityRepo) await mockCommunityRepositoryModule(mocks.communityRepo);
        if (mocks?.iamService) await mockIAMServiceModule(mocks.iamService);
        if (mocks?.authContext) await mockAuthContextRepositoryModule(mocks.authContext);
