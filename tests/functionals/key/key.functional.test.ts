...
describe("(Functional) Key Module", () => {
    ...
    describe("(Functional) Get Key / Download", () => {
        it.each(testCasesGetKey)(
            "GET /keys/:id : $description",
            async ({ key_id, orgs, status_code, expected_error_code, check_data }) => {
                const appModule = await import("../../../src/app.js");
                const app = appModule.default;
    ...
    describe("(Functional) Update Key", () => {
        it.each(testCasesUpdateKey)(
            "PUT /keys/ : $description",
            async ({ body, orgs, status_code, expected_error_code, expected_data }) => {
                const appModule = await import("../../../src/app.js");
                const app = appModule.default;
    ...
    describe("(Functional) Delete Key", () => {
        it.each(testCasesDeleteKey)(
            "DELETE /keys/:id : $description",
            async ({ key_id, orgs, status_code, expected_error_code, expected_data }) => {
                const appModule = await import("../../../src/app.js");
                const app = appModule.default;
