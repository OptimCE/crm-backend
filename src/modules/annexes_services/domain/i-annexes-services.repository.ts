...
export interface IAnnexesServicesRepository {
  ...
  findByCommunityAndFeature(internal_community_id: number, feature: string, query_runner?: QueryRunner): Promise<CommunitySubscription | null>;
  createSubscription(internal_community_id: number, feature: string, is_active: boolean, query_runner?: QueryRunner): Promise<CommunitySubscription>;
