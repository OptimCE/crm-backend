...
// Put (/:id): Update editable fields (name, type, municipalities) of a sharing operation
sharing_operation_routes.put(
  "/:id",
  /* #swagger.summary = 'Update editable fields of a sharing operation'
       #swagger.tags = ['SharingOperations']
       #swagger.parameters['id'] = { $ref: '#/components/parameters/SharingOperationId' }
       #swagger.requestBody = {
           required: true,
           content: {
               "application/json": {
                   schema: { $ref: "#/components/schemas/UpdateSharingOperationDTO" }
               }
           }
       }
       #swagger.responses[200] = { $ref: '#/components/responses/SharingOperationUpdateSuccess' }
       #swagger.responses[400] = { $ref: '#/components/responses/BadRequest' }
       #swagger.responses[401] = { $ref: '#/components/responses/Unauthorized' }
       #swagger.responses[403] = { $ref: '#/components/responses/Forbidden' }
       #swagger.security = [{
  ...
  communityIdChecker(),
  roleChecker(Role.GESTIONNAIRE),
  sharing_operation_controller.updateSharingOperation.bind(sharing_operation_controller),
);
