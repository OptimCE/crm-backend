...
export class SharingOperationController {
     ...
     * @param _next - Express next middleware.
     */
    @sharing_operationControllerTraceDecorator.traceSpan("getSharingOperationConsumptions", { url: "/sharing_operations/:id/consumptions", method: "get" })
     ...
     * @param _next - Express next middleware.
     */
    @sharing_operationControllerTraceDecorator.traceSpan("downloadSharingOperationConsumptions", { url: "/sharing_operations/:id/consumptions/download", method: "get" })
