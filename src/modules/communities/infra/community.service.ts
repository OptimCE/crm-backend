...
export class CommunityService implements ICommunityService {
    ...
    constructor(@inject("CommunityRepository") private community_repository: ICommunityRepository,
    ...
    async addCommunity(new_community: CreateCommunityDTO, query_runner?: QueryRunner): Promise<void> {
        ...
        try{
            ...
            logger.error({ operation: "addCommunity", error: err }, "An exception occurred while adding the user to the new community in the IAM providers");
            throw new AppError(COMMUNITY_ERRORS.ADD_COMMUNITY.IAM_ERROR_CREATE, 400)
        }
        try{
