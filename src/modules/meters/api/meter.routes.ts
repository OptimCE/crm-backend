...
meter_router.get("/",
    ...
    */
    idChecker(), communityIdChecker(), roleChecker(Role.GESTIONNAIRE), meter_controller.getMetersList.bind(meter_controller))
...
meter_router.get("/:id",
    ...
    */
    idChecker(), communityIdChecker(), roleChecker(Role.GESTIONNAIRE), meter_controller.getMeter.bind(meter_controller))
// GET (/:id/consumptions) : Get the consumption of a meter
meter_router.get("/:id/consumptions",
    ...
    */
    idChecker(), communityIdChecker(), roleChecker(Role.GESTIONNAIRE), meter_controller.getMeterConsumptions.bind(meter_controller))
// Get (/:id/consumptions/download): Download the consumption of a meter
meter_router.get("/:id/consumptions/download",
    ...
    */
    idChecker(), communityIdChecker(), roleChecker(Role.GESTIONNAIRE), meter_controller.downloadMeterConsumptions.bind(meter_controller))
...
meter_router.post("/",
    ...
    */
    idChecker(), communityIdChecker(), roleChecker(Role.GESTIONNAIRE), meter_controller.addMeter.bind(meter_controller))
...
*/
    idChecker(), communityIdChecker(), roleChecker(Role.GESTIONNAIRE), meter_controller.updateMeter.bind(meter_controller))
// Patch (/data): Patch meter data
meter_router.patch("/data",
    ...
    */
    idChecker(), communityIdChecker(), roleChecker(Role.GESTIONNAIRE), meter_controller.patchMeterData.bind(meter_controller))
// DELETE (/:id): Delete a meter
meter_router.delete("/:id",
    ...
    */
    idChecker(), communityIdChecker(), roleChecker(Role.GESTIONNAIRE), meter_controller.deleteMeter.bind(meter_controller))
