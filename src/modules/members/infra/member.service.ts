...
export class MemberService implements IMemberService {
  constructor(
    @inject("MemberRepository") private member_repository: IMemberRepository,
  ...
  async updateMember(update_dto: UpdateMemberDTO, query_runner?: QueryRunner): Promise<void> {
    ...
    if (update_dto.home_address) {
      ...
      const next_home_address = {
        ...
        supplement: update_dto.home_address.supplement ?? member.home_address.supplement,
      };
    ...
    if (update_dto.billing_address) {
      const next_billing_address = {
        ...
        supplement: update_dto.billing_address.supplement ?? member.billing_address.supplement,
      };
      try {
