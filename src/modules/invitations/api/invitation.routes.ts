...
invitation_routes.get(
  ...
  /* #swagger.summary = 'Get all own member pending invitations'
    ...
    */
  idChecker(),
  invitation_controller.getOwnMemberPendingInvitation.bind(invitation_controller),
);
...
invitation_routes.get(
  ...
  /* #swagger.summary = 'Get all own managers pending invitations'
    ...
    */
  idChecker(),
  invitation_controller.getOwnManagerPendingInvitation.bind(invitation_controller),
);
...
invitation_routes.post(
  ...
  /* #swagger.summary = 'Accept an invitation member'
    ...
    */
  idChecker(),
  invitation_controller.acceptInvitationMember.bind(invitation_controller),
);
...
invitation_routes.post(
  ...
  /* #swagger.summary = 'Accept an invitation with encoded member'
    ...
    */
  idChecker(),
  invitation_controller.acceptInvitationMemberWEncoded.bind(invitation_controller),
);
...
invitation_routes.post(
  ...
  /* #swagger.summary = 'Accept an invitation for manager'
    ...
    */
  idChecker(),
  invitation_controller.acceptInvitationManager.bind(invitation_controller),
);
...
invitation_routes.delete(
  ...
  /* #swagger.summary = 'Cancel a member own invitation'
    ...
    */
  idChecker(),
  invitation_controller.refuseMemberInvitation.bind(invitation_controller),
);
// DELETE (/:id_invitation/own/manager): Cancel a manager own invitation
invitation_routes.delete(
  "/:id_invitation/own/manager",
  /* #swagger.summary = 'Cancel a manager own invitation'
    ...
    */
  idChecker(),
  invitation_controller.refuseManagerInvitation.bind(invitation_controller),
);
