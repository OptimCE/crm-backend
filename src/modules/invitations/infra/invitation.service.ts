...
export class InvitationService implements IInvitationService {
    constructor(@inject("InvitationRepository") private invitationRepository: IInvitationRepository,
    ...
    async acceptInvitationManager(accept_invitation: AcceptInvitationDTO, query_runner?: QueryRunner): Promise<void> {
        // Fetch invitation
        const invitation: GestionnaireInvitation | null = await this.invitationRepository.getInvitationManagerById(accept_invitation.invitation_id, query_runner)
        if (!invitation) {
        ...
        if (existing_user && existing_user.role === Role.ADMIN) {
            logger.error({ operation: 'acceptInvitationManager' }, "The user can't accept this invitation - An admin can't accept an invitation to become a manager");
        ...
        try {
            ...
            logger.error({ operation: 'acceptInvitationManager', error: err }, "The user can't accept this invitation: An error happened while adding/updating the user to the community in the database");
        ...
        try {
            ...
            logger.error({ operation: 'acceptInvitationManager', error: err }, "The user can't accept this invitation: An error happened while adding the user to the community in the IAM service");
    ...
    async acceptInvitationMember(accept_invitation: AcceptInvitationDTO, query_runner?: QueryRunner): Promise<void> {
        // Fetch invitation
        const invitation: UserMemberInvitation | null = await this.invitationRepository.getInvitationMemberById(accept_invitation.invitation_id, query_runner)
        if (!invitation) {
        ...
        if (!existing_user) {
            try {
                ...
                logger.error({ operation: 'acceptInvitationMember', error: err }, "The user can't accept this invitation: An error happened while adding the user to the community in the database");
            ...
            try {
                ...
                logger.error({ operation: 'acceptInvitationMember', error: err }, "The user can't accept this invitation: An error happened while adding the user to the community in the IAM service");
    ...
    async acceptInvitationMemberWEncoded(accept_invitation: AcceptInvitationWEncodedDTO, query_runner?: QueryRunner): Promise<void> {
        ...
        if (!existing_user) {
            try {
                ...
                logger.error({ operation: 'acceptInvitationMemberWEncoded', error: err }, "The user can't accept this invitation: An error happened while adding the user to the community in the database");
            ...
            try {
                ...
                logger.error({ operation: 'acceptInvitationMemberWEncoded', error: err }, "The user can't accept this invitation: An error happened while adding the user to the community in the IAM service");
    ...
    async inviteUserToBecomeManager(invitation: InviteUser, query_runner?: QueryRunner): Promise<void> {
        let user: User | null;
        user = await this.userRepository.getUserByEmail(invitation.user_email, query_runner);
        try {
