...
- ajouter un exemple de `.env.example` basé sur `config/` ;
- créer un script `Makefile` ou des scripts npm pour simplifier les commandes Docker ;
- ou exécuter les tests dans votre environnement maintenant.
